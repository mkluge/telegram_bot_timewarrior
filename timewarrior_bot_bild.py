...
activities=[ "Administration", "Beratung", "Ausschreibung", "Dokumentation", "Entwicklung", "Feier", "Forschung", "Management", "Meeting", "Ticket-Bearbeitung", "Orga-Chef", "Organisation", "Ortswechsel", "Paper", "Präsentation", "Review", "Schulung", "Selbst-Orga", "Telefonat", "Telefonkonferenz", "Videokonferenz" ]
...
def report_for_activity_list( activity_list, timelen):
	...
	for activity in result:
		result[activity]=str(int(100*result[activity]/sum_secs))+'%,'+str(ltime[activity])
	output=[]
	string=""
